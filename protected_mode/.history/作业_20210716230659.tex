...
\subfigure{
    ...
    \centering
    \includegraphics[width=\textwidth]{figs/3/3_error.png}
    \caption{反汇编出现莫名代码}
    \label{fig:3_error}
    \end{minipage}
}
\subfigure{
    \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{figs/3/3_code.png}
    \caption{莫名代码错误出现的代码段}
    \label{fig:3_code}
    \end{minipage}
}
\end{figure}
...
\subfigure{
    \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/6/6_fail.png}
    \caption{获取内存信息失败}
    \label{fig:6_fail}
    \end{minipage}
}
\subfigure{
    \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{figs/6/6_success.png}
    \caption{获取内存信息成功}
    \label{fig:6_success}
    \end{minipage}
}
...
\subfigure{
    \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/7/with_int.png}
    \caption{使用int 20h指令系统崩溃}
    \label{fig:with_int}
    \end{minipage}
}
\subfigure{
    \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{figs/7/without_int.png}
    \caption{不使用int 20h指令无显示}
    \label{fig:without_int}
    \end{minipage}
}
\end{figure}
...
\subfigure{
    \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/7/ICW1.jpg}
    \caption{ICW1错误}
    \label{fig:ICW1}
    \end{minipage}
}
\subfigure{
    \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{figs/8/variable_unaccessible.png}
    \caption{无法访问变量wheel\_cnt}
    \label{fig:variable_unaccessible}
    \end{minipage}
}
\end{figure}
...
一个操作系统的实现
\bibitem{ref:oranges} 《Orange'S：一个操作系统的实现》 于渊
